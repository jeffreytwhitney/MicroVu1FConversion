...
def micro_vu_lines() -> list[str]:
    output_path = get_output_filepath("446007 END VIEW.iwp")
...
def setup_module():
    ...
    input_path = get_input_filepath("446007 END VIEW.iwp")
...
def test_output_file_exists(micro_vu_lines):
    assert os.path.exists(get_output_filepath("446007 END VIEW.iwp"))
