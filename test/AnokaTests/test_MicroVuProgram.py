...
def micro_vu() -> MicroVuProgram:
    return MicroVuProgram(get_input_filepath("NN00160A001-2_OPFAI_REVC_VMM_REV2.iwp"), "10", "A", "")
...
def test_can_write_to_output_file(micro_vu):
    ...
    shutil.copy(get_input_filepath("NN00160A001-2_OPFAI_REVC_VMM_REV2.iwp"), get_output_filepath("NN00160A001-2_OPFAI_REVC_VMM_REV2.iwp"))
...
def test_filepath(micro_vu):
    assert micro_vu.filepath == get_input_filepath("NN00160A001-2_OPFAI_REVC_VMM_REV2.iwp")
...
def test_output_filepath(micro_vu):
    assert micro_vu.output_filepath == get_output_filepath("NN00160A001-2_OPFAI_REVC_VMM_REV2.iwp")
...
def test_has_bring_part_to_metrology(micro_vu):
    assert micro_vu.has_bring_to_metrology_picture is True
